...
SENSOR_DESCRIPTIONS: tuple[ChmiSensorDescription, ...] = (
    ...
    ChmiSensorDescription(
        ...
        translation_key="yesterday_precipitation",
        value_fn=lambda coordinator, observation: observation.yesterday_precipitation,
        native_unit_of_measurement=UnitOfPrecipitationDepth.MILLIMETERS,
        device_class=SensorDeviceClass.PRECIPITATION,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ChmiSensorDescription(
        ...
        name="Yesterday temperature maximum",
        translation_key="yesterday_temperature_max",
        value_fn=lambda coordinator, observation: observation.yesterday_temperature_max,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ChmiSensorDescription(
        key="yesterday_temperature_min",
        name="Yesterday temperature minimum",
        translation_key="yesterday_temperature_min",
        value_fn=lambda coordinator, observation: observation.yesterday_temperature_min,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ChmiSensorDescription(
        key="yesterday_wind_gust_max",
        name="Yesterday wind gust maximum",
        translation_key="yesterday_wind_gust_max",
        value_fn=lambda coordinator, observation: observation.yesterday_wind_gust_max,
